...
public interface ContractApi {
    ...
    ResponseEntity<ContractDto> putContract(@ApiParam(value = "Id of Contract",required=true) @PathVariable("id") Long id,@ApiParam(value = "" ,required=true )  @Valid @RequestBody ContractUpdateRequestDto contract);
